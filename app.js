...
function correctDate(i) {
    return (i < 10)? "0" + i: i;
}

var url = 'http://kalachteh.ru/schedule/kioskschedule.html'
var i = schedule.scheduleJob('0 0 11 * * *', function() {

  var j = schedule.scheduleJob('* */15 11-13 * * *', function(){
    ...
    if (date != correctDate(dateNow.getDate())) {
      ...
      var endSchedule = schedule.indexOf(`Расписание на ${correctDate(dateNow.getDate())}.${correctDate(dateNow.getMonth()+1)}.${dateNow.getFullYear()}`); 
